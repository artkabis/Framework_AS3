package fr.artkabis.position
{
	...
	public class PosObjet 
	{
		...
		protected function reposition():void 
		{
			...
			new Tween( _target,"width",Strong.easeOut,_target.width,newW,duration,true );
			new Tween( _target,"height",Strong.easeOut,_target.height,newH,duration,true );
		}
