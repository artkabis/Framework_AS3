	...
	*/
	public class WindowBlur 
	{
		 ...
		 */
 		...
 		//==================================================================================================
		public function WindowBlur(pBackground:DisplayObjectContainer, pWindow:DisplayObjectContainer, pBlurAmount:int = 8 ):void 
 		//==================================================================================================
		{
			_background =    pBackground;
			_window     =    pWindow;
			_blurAmount =   (pBlurAmount >= 0 && pBlurAmount <= 255) ? _blurAmount=pBlurAmount : _blurAmount=16;
			_point      =   new Point();
